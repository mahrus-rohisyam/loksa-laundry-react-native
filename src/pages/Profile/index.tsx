...
const Profile = (props: Props) => {
  ...
  return (
    <ScrollView style={{backgroundColor: Colors.white, height: '100%'}}>
      ...
      <View style={{marginBottom: 6}}>
        <CList title="Program Loyalti" desc="Cooming Soon" button={() => {}} />
      </View>
      <View style={{marginBottom: 6}}>
        <CList title="Riwayat" desc="Riwayat pemesanan" button={() => {}} />
      </View>
      <CList
      ...
      <View style={{backgroundColor: '#F6FAFE'}}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.textFAQ}>Logout</Text>
          <Icon name="chevron-right" size={15} color={'#E0E0E0'} />
        </TouchableOpacity>
      </View>
    </ScrollView>
